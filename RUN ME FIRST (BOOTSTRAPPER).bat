...
:gotPrivileges
    ...
    echo.
    echo Installing/upgrading latest Dot NET SDK
    echo.
    ...
    echo.
    echo Installing/upgrading powershell core
    echo.
    ...
    echo.
    echo Installing/upgrading NotePad++
    echo.

    choco upgrade NotePadPlusPlus
	
	echo.
    echo Installing/upgrading GitHub Desktop
    echo.

	choco upgrade github-desktop
	
	echo.
    echo Installing/upgrading Git for Windows
    echo.
...
:finalSteps
	...
	dotnet restore "%~dp0InitializeRepos.sln"
	
	dotnet build "%~dp0InitializeRepos.sln"

	"%~dp0InitializeRepos\Project\bin\Debug\net7.0-windows\InitializeRepos.exe"
